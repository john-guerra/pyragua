...
descripcion_larga = """Pyragua es un entorno de desarrollo para
                                 ...
                                 potente lenguaje."""
imagenes=glob.glob(os.path.join( 'imagenes','*.png'))+glob.glob(os.path.join( 'imagenes','*.ico'))
locales=glob.glob(os.path.join( 'locale','es', '*.po'))
setup (name='Pyragua', 
           version='0.2.3',
           ...
           scripts=['pyragua.py'],            
           data_files= [ ( os.path.join( 'imagenes') , 
                                    imagenes),
                                (os.path.join( 'locale', 'es'), 
                                    locales)  
                                ],
           windows=[
            {
